...
public class MemberCourseController {
     ...
     */
    @PostMapping( "/list")
    //@RequestMapping( value="/memberCourse", headers="Accept=application/json",produces="application/json;charset=UTF-8")
    ...
    @PostMapping( "/save")
    //@RequestMapping( value="/memberCourse", headers="Accept=application/json",produces="application/json;charset=UTF-8")
    public ResponseDto save(@RequestBody MemberCourseDto memberCourseDto){//@RequestBody接收json方式

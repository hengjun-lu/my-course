...
public class VodUtil {
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient,String fileName) throws ClientException{
        ...
        request.setCateId(1000182718L);//分类ID
        request.setTemplateGroupId("c1bdce877311c1988045c1b350cb10ae");//转码模板组ID
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4G8kxtcfAe1z3odquxmN";
        //您的AccessKeySecret
        String accessKeySecret = "rtmZCCUIyP911U8CZA0W3nHsuOYyJZ";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\file\\imooc\\course\\course\\1g9l7gnGuoU60wyKMs84qk.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "1g9l7gnGuoU60wyKMs84qk.mp4";
